...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?php echo base_url('assets/img/PERPUSTAKAAN.png') ?>" class="d-block w-100" alt="...">
    </div>
...
<br>
<a href="<?php echo base_url();?>Dashboard_akhir/export/<?php echo '2';?>" class="btn btn-sm btn-secondary mb-3 mt-3" target="_blank"><i class="fas fa-print fa-sm"></i>Export</a>
...
<!-- <a href="<?= base_url('Ruangan/export') ?>" class="btn btn-primary" target="_blank"><span class='glyphicon glyphicon-print'></span>Export</a> -->
</div>
