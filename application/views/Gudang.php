...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?php echo base_url('assets/img/GUDANG.png') ?>" class="d-block w-100" alt="...">
    </div>
...
<br>
<a href="<?php echo base_url();?>Dashboard_akhir/export/<?php echo '9';?>" class="btn btn-sm btn-secondary mb-3 mt-3" target="_blank"><i class="fas fa-print fa-sm"></i>Export</a>
